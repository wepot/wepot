                        ...
                        <ul class="overviewList">
                            <li class="overviewList_item">
                                <ul>
                                    ...
                                    <li class="overviewList_text">Wepot</li>
                                </ul>
                            </li>
                            <li class="overviewList_item">
                                <ul>
                                    <li class="overviewList_title">ご依頼事項</li>
                                    <li class="overviewList_text">オウンドメディア企画・情報設計・デザイン・実装</li>
                                </ul>
                            </li>
                            <li class="overviewList_item">
                                <ul>
                                    <li class="overviewList_title">納品月</li>
                                    <li class="overviewList_text">2021年8月</li>
                                </ul>
                            </li>
                            <li class="overviewList_item">
                                <ul>
                                    <li class="overviewList_title">URL</li>
                                    <li class="overviewList_text"><a href="https://wepot.jp/" target="_blank" rel=“noopener”>https://wepot.jp/</a></li>
                                </ul>
                            </li>
                        </ul>
