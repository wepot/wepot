...
<main class="main-contents">
                ...
                <section class="profilePage-sec01">
                    ...
                    <ul class="profilePage-sns">
                        <li class="profilePage-sns_item profilePage-sns_item01">
                            <a href="https://tomoni-design.com/"><img src="<?php echo get_template_directory_uri(); ?>/img/icon/s-website.png" alt="">Web
                                Site</a>
                        </li>
                        <li class="profilePage-sns_item profilePage-sns_item02">
                            <a href="https://twitter.com/12designNeko"><img src="<?php echo get_template_directory_uri(); ?>/img/icon/s-twitter.png" alt="">Twitter</a>
                        </li>
                    </ul>
    ...
    <section class="section_container">
        <div class="section_inner">
            <header class="section_heading">
                <h2 class="section_title">奥田が最近書いた記事</h2>
            </header>
            ...
            <div class="more">
                <a href="<?php echo home_url(); ?>/author/tomoni" class="button03">奥田の執筆記事一覧</a>
            </div><!-- /.more -->
        </div><!-- /.section_inner -->
    </section><!-- /.section_container -->
    <?php get_footer(); ?>