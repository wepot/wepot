...
<main class="main-contents">
            ...
            <article class="profilePage">
                ...
                <section class="profilePage-sec02">
                    ...
                    <p class="section_text">
                        学生時代の研究活動を通じて分析力や物事を組み立てる力を身につける。また、学会発表のプレゼンテーション資料や論文の作図において人に伝えるデザインの重要性に気づく。<br>社会人になってから独学でデザインを学び、学生時代に専攻した情報工学分野を生かせる
                        Web 業界を目指す。HTML/CSSの構造を理解しつつ、よりデザインに力を入れたいという思いが強くなる。<br>現在は
                        Webデザインをはじめ、アプリケーションデザインやUIデザイン、ロゴデザインにも制作範囲を広げ、活動中。</p>
    ...
    <section class="section_container">
        <div class="section_inner">
            <header class="section_heading">
                <h2 class="section_title">齋藤が最近書いた記事</h2>
            </header>
            ...
            <div class="more">
                <a href="<?php echo home_url(); ?>/author/saito" class="button03">齋藤の執筆記事一覧</a>
            </div><!-- /.more -->
        </div><!-- /.section_inner -->
    </section><!-- /.section_container -->
    <?php get_footer(); ?>