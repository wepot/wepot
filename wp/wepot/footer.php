        ...
        <div class="footer-menu_wrap">
            <ul class="link">
                ...
                <li class="link_wrap">
                    <p>Follow US</p>
                    <ul class="link-sns">
                        <li class="link-sns_item"><a href="/"><img src="<?php echo get_template_directory_uri(); ?>/img/icon/twitter.png" alt=""></a>
                        </li>
                        <li class="link-sns_item"><a href="/"><img src="<?php echo get_template_directory_uri(); ?>/img/icon/facebook.png" alt=""></a>
                        </li>
                        <li class="link-sns_item"><a href="/"><img src="<?php echo get_template_directory_uri(); ?>/img/icon/linkedin.png" alt=""></a>
                        </li>
                    </ul>
                </li><!-- /.link_wrap -->
            </ul><!-- /.link -->
