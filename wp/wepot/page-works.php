                ...
                <div class="strong-media">
                    <div class="strong-media_item">
                        ...
                        <div class="strong-media_body">
                            ...
                            <p class="strong-media_text">個々に違う強みを持ったフリーランスで構成されたWepotは、どんなビジネス課題にも対応できる体制が整っているため、プロジェクトごとに適切なメンバーをアサインします。<br>例えば、Webサイト制作のご依頼には業界歴10年以上のプロフェッショナルがプロジェクトをリードし、経験豊富なデザイナーがお客様の意向を汲み取りデザイン、SEOを考慮した無駄のないソースコードで実装します。目的から逆算した柔軟なメンバーアサインで、スムーズなプロジェクト進行をいたします。</p>
                        </div>
                    ...
                    <div class="strong-media_item">
                        ...
                        <div class="strong-media_body">
                            ...
                            <p class="strong-media_text">Wepotは、あらゆるクリエイティブを制作するだけでなく、プロジェクトの基盤となる要件定義を重視しています。制作しておわりではなく、お客様が求める成果に結びつくよう戦略や改善ポイントを具現化するご提案をします。<br>また、Webサイトや動画を公開後でもお客様とコミュニケーションをとり、貴社のパートナーとして併走させていただきます。</p>
                        </div>
                    </div><!-- /.strong-media_item -->
                    <div class="strong-media_item">
                        ...
                        <div class="strong-media_body">
                            ...
                            <p class="strong-media_text">Wepotは、少数精鋭のクリエイティブチーム。大規模なWebサイトや新しいWebサービス開発、個人で運営されているお店のホームページ、成果重視の動画広告や情緒的な映像編集、オリジナルのイラスト制作や漫画、ロゴ制作…あらゆるクリエイティブを創出します。<br>1人1人の持つスキル、経験、強み、得意。それらを最大限に活かし、貴社のご要望を実現します。</p>
                        </div>
                    </div><!-- /.strong-media_item -->
                </div><!-- /.strong-media -->
            </div><!-- /.strong -->
